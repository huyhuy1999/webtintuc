...
if (!isset($options['homepage'])) {$options['homepage'] = "off";}
	if (
       ...
       ((is_home() || is_front_page()) && $options['homepage'] == 'on')) {
		$content .= "<!-- Like & Share Button: http://peadig.com/wordpress-plugins/facebook-like-share-button/ -->";
...
function fbls_shortcode($fbatts) {
    ...
    if (!empty($fbatts)) {
		...
		$fbls_sc = "<!-- Like & Share Button: http://peadig.com/wordpress-plugins/facebook-like-share-button/ -->";
