...
$rocket_cookie_hash = '758a505187891c29dad61b509827176f';
$rocket_logged_in_cookie = 'wordpress_logged_in_758a505187891c29dad61b509827176f';
$rocket_cache_mobile_files_tablet = 'desktop';
$rocket_secret_cache_key = '5d97f92f60b71300241397';
$rocket_cache_mobile = 1;
$rocket_do_caching_mobile_files = 0;
$rocket_cache_webp = 0;
$rocket_cache_ssl = 1;
$rocket_cache_reject_uri = '/webtintuc(/(.+/)?feed/?|/(?:.+/)?embed/|/(index\.php/)?wp\-json(/.*|$))';
