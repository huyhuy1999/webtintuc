...
{
    $fonts_url = infinity_news_fonts_url();
    if (!empty($fonts_url)) {
        wp_enqueue_style('infinity-news-google-fonts', $fonts_url, array(), null);
    }
    ...
    wp_enqueue_script('infinity-news-custom-script', get_template_directory_uri() . '/assets/lib/twp/js/script.js', array('jquery'), '', 1);
    ...
    wp_localize_script( 
        'infinity-news-custom-script', 
        'infinity_news_custom_script',
        array(
...
function infinity_news_admin_scripts()
{
    ...
    if( $current_screen->id === "widgets" ) {
        ...
        wp_enqueue_media();
        wp_enqueue_script('infinity-news-custom-widgets', get_template_directory_uri() . '/assets/lib/twp/js/widget.js', array('jquery'), '1.0.0', true);
